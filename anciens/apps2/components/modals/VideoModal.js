...
class VideoModal extends Component {
  ...
  gocam = async () => {
    ...
    try {
      const response = await fetch(base_url + '/portail-stagiaire/langue.php', {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
      ...
      const idlangue = await response.json();
        ...
        <View style={{backgroundColor:'#192356', height:hp('100%')}}>
          ...
          <ScrollView
            ...
            <View>
                <View
                  style={{
                    ...
                    style={{
                      ...
                      <MaterialIcons name={'movie'} size={70} color={'#FFFF'} />
                    </View>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', alignSelf:'center' , marginTop:hp('7%')}}>
