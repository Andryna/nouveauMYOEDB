...
export default class Room extends Component {
  ...
  updateAgentAndUrl() {
    ...
    const agent = type === '0' ? 'stag' : 'prof';
    const url3 = `https://preprod.forma2plus.com/disk2/dropbox/iframe_test.php?group_member_id=${this.state.id}_${this.state.id_groupe}&agent=${agent}&room_id=${this.state.id}_${this.state.id_groupe}&date=${moment(new Date()).format("YYYY-MM-DD")}`;
...
//  alert("https://preprod.forma2plus.com/mbed_jitsi/jitsi.php?id_call="+this.state.id+'_'+this.state.id_groupe+"&agent=stag");
  ...
  render() {
    ...
    const url = 'https://preprod.forma2plus.com/disk2/dropbox/iframe_test.php?group_member_id='+this.state.id+'_'+this.state.id_groupe+'&agent=stag&room_id='+this.state.id+'_'+this.state.id_groupe+'&date='+moment(new Date()).format("YYYY-MM-DD");
