...
getAudioPermissionType = () => {
  ...
  checkPermission = async () => {
    const permissionType = this.getAudioPermissionType();
    ...
    try {
      ...
      switch (result) {
        case RESULTS.UNAVAILABLE:
          console.log('Cette fonctionnalité n\'est pas disponible sur cet appareil.');
          return false;
        case RESULTS.DENIED:
          console.log('Permission refusée mais peut être demandée.');
          return false;
        case RESULTS.LIMITED:
          console.log('Permission limitée : certaines actions sont possibles.');
          return true;
        case RESULTS.GRANTED:
          console.log('Permission accordée.');
          return true;
        case RESULTS.BLOCKED:
          console.log('Permission refusée et ne peut plus être demandée.');
          Alert.alert(
            'Permission requise',
            'Vous devez activer la permission du micro dans les paramètres.',
            [
              { text: 'Annuler', style: 'cancel' },
              { text: 'Ouvrir Paramètres', onPress: () => openSettings() },
            ]
          );
          return false;
        default:
  ...
  // Vérifier ET demander si nécessaire
            ...
            <View>
              ...
              <View
                style={{
                  ...
                  {/* <Text style={{color:'white'}}>LANGUAGE {this.state.pickerValueHolder}</Text> */}
...
<View style={styles.renameModal}>
        ...
        <AudioTextModal
          ...
          infolangue = {this.state.infolangue}
          // infolangue = {null}
          save={() => {
            this.closeModal(),
