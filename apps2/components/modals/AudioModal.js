    ...
    return (
      <Modal transparent={true} animationType="slide" visible={this.props.visible}>
        <View style={{backgroundColor:'#192356', height:hp('100%')}}>
          ...
          <ScrollView
            style={{ height: hp('65%'), width: wp('100%'), borderRadius: 15, marginTop: hp('1.5%') }}>
            <View>
              <View
                style={{ fontSize: hp('3.2%'), fontWeight: 'bold', borderColor: 'grey' }}>
                <View
                  style={{
                    justifyContent: 'center',
                  }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <TouchableOpacity
                    ...
                    //   alert("ok")
                    this.props.onClose(),this.toEnregistre()
                    }}>
                  ...
                  <TouchableOpacity
                    style={[Add.real, { width: wp('43%'), height: hp('12%'), borderRadius: 5, backgroundColor: '#62CAD6' }]}
                    onPress={() => {
                      this.props.onClose(), this.speaking()
                      // alert("ok")
                    }}>
