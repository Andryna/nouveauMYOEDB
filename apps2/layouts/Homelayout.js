...
import { openHome, OpenCat, Openjitsi, OpenAlo, OpenEl, Openjitsi2, OpenChat} from '../utils/All';
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        {!keyboardVisible && (
          <View style={{ width: wp('100%'), position: 'absolute', justifyContent: 'center', alignItems: 'center', bottom: 0, zIndex:1 }}>
            <Footer
